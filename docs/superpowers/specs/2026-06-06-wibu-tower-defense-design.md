...
- Characters are **original** — original names and traits — _inspired by_ famous anime of all
...
- **Roles (6):** damage, splash, chain, dot, support/buff, debuff/CC. _(Economy/gold is no
  longer a tower role — gold generation moved to the Pet item slot.)_
...
- Fixed **lane(s)** to the castle; **flying units beeline the castle** (not immune to all ground
  towers; hero has anti-air reach; dedicated anti-air is _better_ vs air, not _exclusive_).
...
1. **Phase 1 — Playable core (THIS PHASE).** Phaser+TS skeleton; one stage; lane + flying
   ...
   _Squares for art._ Goal: prove the loop is fun.
