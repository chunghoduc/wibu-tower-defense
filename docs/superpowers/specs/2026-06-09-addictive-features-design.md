...
loops to raise retention and "addictiveness" — _without_ fracturing the economy or
...
Each tower banks mastery XP from kills _while deployed_. Mastery levels (curve, soft cap 10)
...
**Loop:** Meta. **Bartle:** Achiever/Killer. **Feeling:** fair chase for a _specific_ unit.
