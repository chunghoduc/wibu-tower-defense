...
export function goldIcon(): RewardIconView {
  return { iconKey: "icon__gold", emoji: "🪙", color: GOLD_INT };
}
export function diamondIcon(): RewardIconView {
  return { iconKey: "icon__gem", emoji: "💎", color: DIAMOND_INT };
}
export function xpIcon(): RewardIconView {
  return { iconKey: "icon__xp", emoji: "⭐", color: XP_INT };
}
...
function buildCell(
  ...
  cell.add(
    crispText(scene, 0, 30, prize.label, {
      fontSize: "12px",
      color: "#ffe9b0",
      fontStyle: "bold",
      align: "center",
