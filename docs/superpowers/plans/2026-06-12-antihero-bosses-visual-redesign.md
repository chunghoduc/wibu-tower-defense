...
export class BossSkillFx {
  ...
  cast(at: Vec2, skillType: string, radius: number, name: string): void {
    ...
    switch (spec.signature) {
      case "quake":
        this.quake(at, radius, spec.color);
        break;
      case "rally":
        this.rally(at, radius, spec.color);
        break;
      case "barrier":
        this.barrier(at, radius, spec.color);
        break;
      case "summon-surge":
        this.summonSurge(at, radius, spec.color);
        break;
      default:
        this.ring(at, radius, spec.color, 600);
    }
  }
