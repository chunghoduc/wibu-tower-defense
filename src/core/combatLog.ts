...
export function setCombatLogSink(s: Sink | null): void { sink = s; }

/** True when logging is active — guard expensive log-building at call sites. */
export function combatLogOn(): boolean { return sink !== null; }
...
function fmtRoll(r: number): string { return Number.isNaN(r) ? "—" : r.toFixed(3); }
