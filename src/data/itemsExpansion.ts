...
export const EXPANSION_LINES: ItemLine[] = [
  ...
  // homage: Final Fantasy VII → Buster Sword
  {
    ...
    primaryBase: 0.1,
    stats: { atk: 20 },
    affixPool: ["critDamage", "armorPen", "atk"],
  },
  ...
  // homage: Greek myth → the Bow of Apollo
  {
    ...
    primary: "magicDamage",
    primaryBase: 0.13,
    stats: { atk: 11, skillPower: 0.12 },
    affixPool: ["magicPen", "skillPower", "range"],
  },
  // homage: The Dark Tower → the gunslinger's revolver
  {
    id: "peacekeeper-revolver",
  ...
  // homage: Metroid → the arm cannon
  {
    ...
    primaryBase: 0.11,
    stats: { atk: 19 },
    affixPool: ["armorPen", "critRate", "attackSpeed"],
  },
  ...
  {
    id: "mithrilweave-shirt",
    base: "Mithrilweave Shirt",
    slot: "BodyArmor",
    archetype: "defense",
    primary: "damageReduction",
    primaryBase: 0.05,
    stats: { maxHp: 80, damageReduction: 0.03 },
    affixPool: ["maxHp", "magicResist", "tenacity"],
  },
  ...
  // homage: Skyrim → dragonscale armor
  {
    ...
    primary: "magicResist",
    primaryBase: 0.09,
    stats: { maxHp: 85, magicResist: 14 },
    affixPool: ["magicResist", "maxHp", "damageReduction"],
  },
  // homage: Marvel → the vibranium shield
  {
    ...
    primary: "damageReduction",
    primaryBase: 0.05,
    stats: { maxHp: 100, armor: 12, damageReduction: 0.03 },
    affixPool: ["maxHp", "armor", "magicResist"],
  },
  // homage: Final Fantasy → the Ribbon
  {
    ...
    primary: "tenacity",
    primaryBase: 0.08,
    stats: { maxHp: 55, tenacity: 0.06 },
    affixPool: ["tenacity", "magicResist", "hpRegen"],
  },
  // homage: Greek myth → the Helm of Hades
  {
    ...
    primary: "moveSpeed",
    primaryBase: 0.1,
    stats: { moveSpeed: 16, critRate: 0.03 },
  ...
  // homage: generic knightly homage
  {
    ...
    primary: "maxHp",
    primaryBase: 0.07,
    stats: { maxHp: 75, armor: 6 },
    affixPool: ["armor", "magicResist", "hpRegen"],
  },
  // homage: Doctor Strange → the Eye of Agamotto
  {
    id: "seerlight-circlet",
    base: "Seerlight Circlet",
    slot: "Helmet",
    archetype: "magic",
    primary: "skillPower",
    primaryBase: 0.09,
    stats: { manaOnHit: 4, skillPower: 0.08 },
  ...
  {
    id: "titanhold-gauntlets",
    base: "Titanhold Gauntlets",
    slot: "Gloves",
    archetype: "physical",
    primary: "critDamage",
    primaryBase: 0.13,
    stats: { critDamage: 0.1, atk: 8 },
  ...
  // homage: folklore → the seven-league boots
  {
    ...
    primaryBase: 0.11,
    stats: { moveSpeed: 26 },
    affixPool: ["moveSpeed", "tenacity", "goldFind"],
  },
  ...
  // homage: myth → the phoenix
  {
    ...
    primary: "skillPower",
    primaryBase: 0.09,
    stats: { moveSpeed: 22, skillPower: 0.08 },
    affixPool: ["skillPower", "hpRegen", "moveSpeed"],
  },

  // ── Rings — completes the ring archetype matrix ───────────────────────────
  // homage: Diablo II → the Stone of Jordan
  {
    id: "juggernaut-signet",
    ...
    primaryBase: 0.08,
    stats: { atk: 6 },
    affixPool: ["atk", "critDamage", "armorPen"],
  },
  // homage: DC → a power ring
  {
    ...
    primary: "skillPower",
    primaryBase: 0.1,
    stats: { skillPower: 0.08, manaOnHit: 2 },
    affixPool: ["skillPower", "magicPen", "manaOnHit"],
  },
  // homage: generic ring of protection
  {
    ...
    primary: "maxHp",
    primaryBase: 0.07,
    stats: { maxHp: 45, armor: 6 },
    affixPool: ["armor", "maxHp", "damageReduction"],
  },
  // homage: LOTR → the One Ring (stealth + fortune read as mobility + gold)
  {
    ...
    primary: "goldFind",
    primaryBase: 0.08,
    stats: { goldFind: 0.05, moveSpeed: 8 },
    affixPool: ["goldFind", "moveSpeed", "tenacity"],
  },

  // ── Amulets ───────────────────────────────────────────────────────────────
  // homage: generic war-charm
  {
    id: "warpriest-talisman",
    base: "Warpriest Talisman",
    slot: "Amulet",
    archetype: "physical",
    primary: "critDamage",
    primaryBase: 0.11,
    stats: { atk: 6, critDamage: 0.06 },
    affixPool: ["critRate", "atk", "armorPen"],
  },
  // homage: Elder Scrolls → the Amulet of Kings
  {
    ...
    primary: "magicPen",
    primaryBase: 0.08,
    stats: { skillPower: 0.08, magicPen: 0.05 },
    affixPool: ["magicPen", "skillPower", "manaOnHit"],
  },
  // homage: generic ward
  {
    ...
    primary: "magicResist",
    primaryBase: 0.08,
    stats: { magicResist: 10, maxHp: 40 },
    affixPool: ["magicResist", "maxHp", "tenacity"],
  },
  // homage: Greek myth → the touch of Midas
  {
    ...
    primaryBase: 0.09,
    stats: { goldFind: 0.07 },
    affixPool: ["goldFind", "manaOnKill", "moveSpeed"],
  },
  // homage: Marvel → the arc reactor
  {
    id: "heartforge-pendant",
    base: "Heartforge Pendant",
    slot: "Amulet",
    archetype: "defense",
    primary: "hpRegen",
    primaryBase: 0.1,
    stats: { hpRegen: 5, maxHp: 50 },
    affixPool: ["hpRegen", "maxHp", "damageReduction"],
  },
  ...
  // homage: Zelda → the fairy companion
  {
    ...
    primaryBase: 0.1,
    stats: { skillPower: 0.08, manaOnHit: 2 },
    affixPool: ["skillPower", "manaOnHit", "magicPen"],
  },
  // homage: folklore → the iron golem
  {
    id: "iron-sentinel-chibi",
    base: "Iron Sentinel",
    slot: "Pet",
    archetype: "defense",
    primary: "maxHp",
    primaryBase: 0.08,
    stats: { maxHp: 50, armor: 6 },
    affixPool: ["maxHp", "armor", "magicResist"],
  },
  ...
  // homage: myth → the nine-tailed fox
  {
    ...
    primary: "manaOnHit",
    primaryBase: 4,
    stats: { manaOnHit: 3, skillPower: 0.06 },
    affixPool: ["manaOnHit", "skillPower", "manaOnKill"],
  },
];
