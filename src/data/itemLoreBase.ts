...
export const ITEM_LORE_BASE: Record<string, ItemLoreEntry> = {
  ...
  "iron-sword": {
    name: "Dawncut Katana",
    appearance: { family: "greatblade", material: { tint: "#c0cbd8", accent: "#1a1a22" },
  ...
  "elven-bow": {
    ...
    appearance: { family: "bow", material: { tint: "#5a8a4a", accent: "#e8d070" },
  ...
  "arcane-staff": {
    ...
    appearance: { family: "staff", material: { tint: "#6a4a8a", accent: "#b07ad8" },
  ...
  "thunder-cannon": {
    ...
    appearance: { family: "firearm", material: { tint: "#7a6a4a", accent: "#4dc6f6" },
  ...
  "leather-cap": {
    ...
    appearance: { family: "helm", material: { tint: "#8a6a3a", accent: "#5a4426" },
  ...
  "cloth-robe": {
    ...
    appearance: { family: "robe", material: { tint: "#7a8aa0", accent: "#5a6678" },
  ...
  "scale-mail": {
    ...
    appearance: { family: "chestplate", material: { tint: "#8a9aa8", accent: "#6a7686" },
  ...
  "worn-gloves": {
    name: "Trainee Wraps",
    appearance: { family: "gloves", material: { tint: "#8a6a4a", accent: "#5a4426" },
  ...
  "assassin-gloves": {
    ...
    appearance: { family: "gloves", material: { tint: "#3a3a4a", accent: "#d23b3b" },
  ...
  "worn-boots": {
    name: "Wayfarer Boots",
    appearance: { family: "boots", material: { tint: "#8a6a4a", accent: "#5a4426" },
  ...
  "swift-boots": {
    ...
    appearance: { family: "boots", material: { tint: "#4a8a6a", accent: "#eaf6ff" },
  ...
  "mana-pendant": {
    ...
    appearance: { family: "amulet", material: { tint: "#caa84a", accent: "#4da6f6" },
  ...
  "copper-ring": {
    ...
    appearance: { family: "ring", material: { tint: "#c08a4a", accent: "#e0b070" },
  ...
  "resonance-ring": {
    ...
    appearance: { family: "ring", material: { tint: "#c0cbd8", accent: "#9c4dd0" },
  ...
  "fortune-fox": {
    ...
    appearance: { family: "familiar", material: { tint: "#e8902a", accent: "#f5b060" },
  ...
  "fledgling-wings": {
    ...
    appearance: { family: "wings", material: { tint: "#e8eef4", accent: "#ffffff" },
  ...
  "dawnbreaker": {
    ...
    appearance: { family: "greatblade", material: { tint: "#f0e6c0", accent: "#ffd24a" },
  ...
  "void-render": {
    ...
    appearance: { family: "firearm", material: { tint: "#3a2a4a", accent: "#9c4dd0" },
  ...
  "aegis-of-dawn": {
    ...
    appearance: { family: "chestplate", material: { tint: "#e8d8a0", accent: "#ffd24a" },
  ...
  "seers-eye": {
    ...
    appearance: { family: "amulet", material: { tint: "#caa84a", accent: "#d23b3b" },
