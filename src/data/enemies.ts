...
export const ENEMIES: EnemyDef[] = [
  ...
  //     Authored at the Chapter-1 power tier; the progression curve scales them per chapter.
  {
    ...
    special: {
      attacksTowers: { range: 95 },
      frenzy: { belowHpPct: 0.5, speedMult: 1.8, atkMult: 1.6 },
    },
    artRef: "placeholder",
  },
  {
  ...
  // --- Mid-boss: a teaching enrager ---
  {
    ...
    boss: {
      ...
      skill: {
        id: "champion-quake",
        name: "Seismic Slam",
        description: "Slams the ground — stuns nearby towers and hurts the hero.",
        manaCost: 110,
        type: "quake",
        radius: 150,
        power: 0.14,
  ...
  // --- Final boss: enrage + the works ---
  {
    ...
    boss: {
      ...
      skill: {
        id: "warden-barrier",
        name: "Bulwark Ward",
        description: "Shields the Warden and nearby foes.",
        manaCost: 100,
        type: "barrier",
        radius: 170,
        power: 0.3,
  ...
  // --- Final boss variant: summoner + tower-disabler ---
  {
    ...
    boss: {
      ...
      skill: {
        id: "overlord-surge",
        name: "Grave Surge",
        description: "Tears open the ground to spew a horde of imps.",
        manaCost: 120,
        type: "summon-surge",
        power: 4,
        summonId: "imp",
