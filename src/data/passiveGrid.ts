...
export const PASSIVE_NODES: PassiveNodeDef[] = [
  ...
  n({
    ...
    gridX: 9,
    gridY: 6,
    neighbors: ["brawler-notable-1", "brawler-jewel-1"],
  ...
  n({
    ...
    region: "arcane",
    name: "Font of Power",
    description: "+8 manaOnHit, +12% skillPower.",
    gridX: 19,
    gridY: 8,
    neighbors: ["arcane-p3", "arcane-keystone-1"],
    increased: { skillPower: 0.12 },
    flat: { manaOnHit: 8 },
  }),
  n({
    ...
    gridX: 20,
    gridY: 9,
    neighbors: ["arcane-notable-2", "arcane-p4"],
    effectId: "spellweave",
    more: { skillPower: 1.0 },
  }),
  n({
