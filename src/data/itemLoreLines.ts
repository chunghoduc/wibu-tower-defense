...
export const ITEM_LORE_LINES: Record<string, ItemLoreEntry> = {
  "warblade": {
    ...
    appearance: { family: "greatblade", material: { tint: "#d8dde6", accent: "#1c2740" },
  ...
  "longbow": {
    ...
    appearance: { family: "bow", material: { tint: "#8a6a3a", accent: "#e8d8a0" },
  ...
  "wizard-staff": {
    ...
    appearance: { family: "staff", material: { tint: "#6a4a8a", accent: "#d23b3b" },
  ...
  "hand-cannon": {
    ...
    appearance: { family: "firearm", material: { tint: "#b8c0cc", accent: "#d9a441" },
  ...
  "grimoire": {
    ...
    appearance: { family: "tome", material: { tint: "#2a3550", accent: "#6ee06e" },
  ...
  "war-fists": {
    ...
    appearance: { family: "gauntlet", material: { tint: "#c8ccd2", accent: "#ffd24a" },
  ...
  "warhelm": {
    ...
    appearance: { family: "helm", material: { tint: "#aeb6c2", accent: "#6a7686" },
  ...
  "mage-cowl": {
    ...
    appearance: { family: "helm", material: { tint: "#3a4a6a", accent: "#c9b8ff" },
  ...
  "platemail": {
    base: "Claymore Plate",
    appearance: { family: "chestplate", material: { tint: "#b6bcc6", accent: "#8a93a0" },
  ...
  "battle-robe": {
    ...
    appearance: { family: "robe", material: { tint: "#c2873a", accent: "#e8c84a" },
  ...
  "brigandine": {
    ...
    appearance: { family: "chestplate", material: { tint: "#6a5a3a", accent: "#9a8a5a" },
  ...
  "battle-gloves": {
    ...
    appearance: { family: "gloves", material: { tint: "#4a8a6a", accent: "#d8dde6" },
  ...
  "swift-gloves": {
    ...
    appearance: { family: "gloves", material: { tint: "#4aa0d8", accent: "#eaf6ff" },
  ...
  "assassin-mitts": {
    ...
    appearance: { family: "gloves", material: { tint: "#2a2a36", accent: "#d23b3b" },
  ...
  "striders": {
    ...
    appearance: { family: "boots", material: { tint: "#2a3550", accent: "#d8dde6" },
  ...
  "war-boots": {
    ...
    appearance: { family: "boots", material: { tint: "#5a5a64", accent: "#aeb6c2" },
  ...
  "mana-talisman": {
    ...
    appearance: { family: "amulet", material: { tint: "#caa84a", accent: "#6ee0e0" },
  ...
  "focus-gem": {
    base: "Soul Focus Gem",
    appearance: { family: "amulet", material: { tint: "#caa84a", accent: "#f6d24a" },
  ...
  "pierce-pendant": {
    ...
    appearance: { family: "amulet", material: { tint: "#caa84a", accent: "#cfd6e2" },
  ...
  "blood-ring": {
    ...
    appearance: { family: "ring", material: { tint: "#6a1a1a", accent: "#d23b3b" },
  ...
  "fortune-ring": {
    ...
    appearance: { family: "ring", material: { tint: "#caa84a", accent: "#f5d870" },
  ...
  "precision-ring": {
    base: "Hawk-Eye Band",
    appearance: { family: "ring", material: { tint: "#2a3550", accent: "#6ee06e" },
  ...
  "vital-ring": {
    ...
    appearance: { family: "ring", material: { tint: "#4a8a4a", accent: "#9ce89c" },
  ...
  "aegis-charm": {
    ...
    appearance: { family: "amulet", material: { tint: "#caa84a", accent: "#4d9bf0" },
  ...
  "coin-pet": {
    ...
    appearance: { family: "familiar", material: { tint: "#e8c84a", accent: "#f5d870" },
  ...
  "fortune-pet": {
    base: "Payday Felynx",
    appearance: { family: "familiar", material: { tint: "#b8941f", accent: "#f5d870" },
  ...
  "skywings": {
    ...
    appearance: { family: "wings", material: { tint: "#7ad1ff", accent: "#eaf6ff" },
  ...
  "frost-glaive": {
    ...
    appearance: { family: "greatblade", material: { tint: "#bfe6ff", accent: "#4d9bf0" },
  ...
  "venom-fang": {
    ...
    appearance: { family: "gauntlet", material: { tint: "#4a8a4a", accent: "#9c4dd0" },
  ...
  "bulwark-plate": {
    ...
    appearance: { family: "chestplate", material: { tint: "#b6bcc6", accent: "#4d9bf0" },
  ...
  "oracle-crown": {
    ...
    appearance: { family: "helm", material: { tint: "#2a2a4a", accent: "#d23b3b" },
  ...
  "shadowstep-treads": {
    ...
    appearance: { family: "boots", material: { tint: "#2a2a36", accent: "#6e6e88" },
  ...
  "duelist-band": {
    base: "Duelist's Band",
    appearance: { family: "ring", material: { tint: "#cfd6e2", accent: "#4d9bf0" },
