...
export const CHAPTER_THEMES: ChapterTheme[] = [
  { id: "greenwood", name: "Greywood Pass", bgKey: bgKey("chapter-greenwood"), terrainTint: 0xffffff, groundOverlay: 0x16201a,
    block: ["jungle", "stone", "water", "jungle"], decor: ["grass", "grass"] },
  { id: "frost", name: "Frostpeak Reach", bgKey: bgKey("chapter-frost"), terrainTint: 0xffffff, groundOverlay: 0x18222e,
    block: ["ice", "snow", "mountain", "ice"], decor: ["snow", "stone"] },
  { id: "desert", name: "Sunscar Wastes", bgKey: bgKey("chapter-desert"), terrainTint: 0xffe0b0, groundOverlay: 0x241d12,
    block: ["stone", "mountain", "sand"], decor: ["sand", "sand"] },
  { id: "volcanic", name: "Emberfall", bgKey: bgKey("chapter-volcanic"), terrainTint: 0xffffff, groundOverlay: 0x2a1410,
    block: ["lava", "stone", "mountain", "lava"], decor: ["sand"] },
  { id: "swamp", name: "Mire Hollow", bgKey: bgKey("chapter-swamp"), terrainTint: 0xcfe0a0, groundOverlay: 0x18220f,
    block: ["water", "jungle", "water"], decor: ["grass", "sand"] },
  { id: "corrupted", name: "The Blight", bgKey: bgKey("chapter-corrupted"), terrainTint: 0xffffff, groundOverlay: 0x1d1430,
    block: ["crystal", "stone", "crystal", "mountain"], decor: ["crystal", "stone"] },
];
...
const STAGE_BIOMES: Record<number, StageBiome> = {
  ...
  2: { terrainTint: 0xe6cfa0, groundOverlay: 0x241d12, block: ["stone", "mountain", "stone"], decor: ["sand", "grass"] },
  // 3 — Twin Fords: forest cut by a river
  3: { terrainTint: 0xeaf2ea, groundOverlay: 0x14202a, block: ["water", "water", "jungle", "stone"], decor: ["grass", "sand"] },
  // 6 — Quarry Descent: bare grey stone pit
  6: { terrainTint: 0xd7dbe2, groundOverlay: 0x1b1e24, block: ["stone", "mountain", "stone"], decor: ["stone", "sand"] },
  // 7 — Cinder Crossroads: molten lava field
  7: { terrainTint: 0xffffff, groundOverlay: 0x2a1410, block: ["lava", "stone", "mountain", "lava"], decor: ["sand"] },
  // 8 — Mistgrove Loop: dense misty grove
  8: { terrainTint: 0xc4d49a, groundOverlay: 0x16220f, block: ["jungle", "water", "jungle"], decor: ["grass", "grass"] },
