...
export const TOWERS_C: CharacterDef[] = [
  ...
  t({
    ...
    meta: {
      ...
      outfit: "A green hooded ranger's cloak over light leathers, a long elegant bow and a tall quiver",
  ...
  t({
    ...
    meta: {
      ...
      outfit: "A heavy hunter's longcoat and bracers, a bulky steel-limbed crossbow braced on one knee",
      weapon: { family: "crossbow", display: "A heavy steel crossbow firing armor-splitting bolts" },
    },
  ...
  t({
    ...
    meta: {
      ...
      outfit: "A dark hooded assassin's wrap with vials of green toxin at the belt, a slim repeating crossbow",
      weapon: { family: "crossbow", element: "poison", display: "A repeating crossbow loosing venom-soaked bolts" },
    },
  ...
  t({
    ...
    meta: {
      ...
      outfit: "An ink-stained scholar's robe with a quill behind one ear, a floating open black grimoire",
      weapon: { family: "tome", element: "poison", display: "A black grimoire whose written hexes rot the flesh" },
    },
  ...
  t({
    ...
    meta: {
      ...
      outfit: "A high-collared violet academic robe with gold trim, an enchanted tome and a glowing quill",
      weapon: { family: "tome", display: "A spell-codex that scribes weakening hexes onto its targets" },
    },
  ...
  t({
    ...
    meta: {
      ...
      outfit: "A white-and-gold royal gown with a winged circlet, bearing a tall jewelled scepter of light",
      weapon: { family: "scepter", element: "holy", display: "A jewelled royal scepter radiating a warding light" },
    },
  ...
  t({
    ...
    meta: {
      ...
      outfit: "A storm-grey priestly robe with crackling blue trim, a copper scepter capped by a charged crystal",
      weapon: { family: "scepter", element: "lightning", display: "A copper scepter that arcs chaining bolts of storm" },
    },
  ...
  t({
    ...
    meta: {
      ...
      outfit: "An oversized starry mage-robe and a slightly-too-big pointed hat, a stubby crystal-tipped wand",
      weapon: { family: "wand", element: "lightning", display: "A short crystal wand spitting scattering sparks" },
    },
  ...
  t({
    ...
    meta: {
      ...
      outfit: "A deep-blue mage's coat with silver sigils and a focusing monocle, a long rune-etched wand",
